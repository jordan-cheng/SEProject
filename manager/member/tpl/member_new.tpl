        ...
        <section class="content">          
          <div class="row">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" name="formp" method="post" action="member_new_submit.php" onsubmit="return CheckSubmit(this)">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <!--div class="input-group">
                            ...
                            <input type="text" name="id" class="form-control" id="id" placeholder="Enter ID" value="{{T_ID}}" > 
                          <!--/div--><!-- /.input group -->
                        </div><!-- /.form group --> 
                      </div><!-- /.col -->  
                      <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="radio">
                                <label>
                                  <input type="radio" name="radioLevel" id="rdoStudent" value="student" onClick="ClickRadio(this);" checked><strong>Student</strong> 
                                </label>
                              </div>
                              <div class="radio">
                                <label>
                                  <input type="radio" name="radioLevel" id="rdoStaff" value="staff" onClick="ClickRadio(this);"><strong>Staff</strong> &nbsp;&nbsp;(All authority)
                                </label>
                              </div>
