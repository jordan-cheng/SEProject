      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Profile Eidt</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" name="formp" method="post" action="myinfo_submit.php" onsubmit="return CheckSubmit(this)">                
                  <div class="box-body">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="s_dept" class="form-control" id="s_dept"  placeholder="Enter Memo" value="{{T_DEPT}}" > 
                          </div><!-- /.input group -->
                        </div><!-- /.form group --> 
                      </div><!-- /.col -->  
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="s_jobtitle" class="form-control" id="s_jobtitle"  placeholder="Enter Memo" value="{{T_JOBTITLE}}" > 
                          </div><!-- /.input group -->
                        </div><!-- /.form group --> 
                      </div><!-- /.col -->                          
                    </div><!-- /.row -->
                  ...
                  <div class="box-footer" align="center">
                    ...
                    <a href="../main/main.php">
                     ...
                     <!--&nbsp;                    
                    <button type="button" class="btn btn-danger" onclick="GO_DELETE('{{T_ID}}');">Delete</button-->
                  </div>
                </form>
              </div><!-- /.box -->
             </div>
